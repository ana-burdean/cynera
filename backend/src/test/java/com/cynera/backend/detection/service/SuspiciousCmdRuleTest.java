...
class SuspiciousCmdRuleTest {

    private final SuspiciousCmdRule rule =
            new SuspiciousCmdRule();

    @Test
    void shouldDetectCmdExe() {
        SecurityEvent event = createEvent("cmd.exe");
    ...
    @Test
    void shouldDetectCmd() {
        SecurityEvent event = createEvent("cmd");
